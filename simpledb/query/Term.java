...
public class Term {
   ...
   * where F is the specified field and c is some content.
   ...
   */
  public String equatesWithFString(String fldname) {
    if (lhs.isFieldName() &&
        lhs.asFieldName().equals(fldname) &&
        rhs.isFieldName())
  ...
  /**
   * Return true if both of the term's expressons
   * apply to the specified schema.
   * 
   * @param sch the schema
   * @return true if both expressons apply to the schema
   */
