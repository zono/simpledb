...
/**
 * A query planner that optimizes using heuristic-based algorithm.
 * 
...
public class HeuristicQueryPlanner implements QueryPlanner {
  ...
  public HeuristicQueryPlanner(MetadataMgr mgm) {
    this.mdm = mdm;
  }
   ...
   * heuristics.
   * H1. Choose the smallest table (considering selection predicats)
  ...
  private Plan getLowerstPlan(Plan current) {
    TablePlanner besttp = null;
    Plan bestplan = null;
    for (TablePlanner tp : tableplanners) {
      Plan plan = tp.makeSelectPlan();
