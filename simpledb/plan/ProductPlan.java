...
public class ProductPlan {
  ...
  /**
   * Create a new product node in the query tree,
  ...
  /**
   * Estimates the number of block acceesses in the product.
   * The formula is:
   * 
   * <pre>
  ...
  /**
   * Estimate the number of output records in the product.
   * The formula is:
   * 
   * <pre>
   ...
   * </pre>
   * 
   * @see simpledb.plan.Plan#recoresOutput()
   */
   ...
   * Since the product does not increase or decrese field values,
   ...
   * which is the union of the schemas of the underlying queryis.
   * 
   * @see simpoledb.plan.Plan#schema()
   */
