...
public class SelectPlan implements Plan {
  ...
  /**
   * Create a new select node in the query tree,
  ...
  /**
   * Creates a slect scan for this query.
   * 
   ...
   * in the projection.
   * If the predicate contains a term quating the specified
   ...
   * which is the same in the underlying query.
   * 
