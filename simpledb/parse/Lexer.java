...
public class Lexer {
  ...
  /**
   * Return true if the current token is the specified keyword.
   * 
   * @param w the keyward string
  ...
  /**
   * Return ture if the current token is a legal identifier.
   * 
   ...
   * 
   * @return the string value of the cureent token
   */
  public String eatId() {
    if (!matchId())
      throw new BadSyntaxException();
