...
public class SortScan implements Scan {
  ...
  /**
   * Position the scan befoore the first record in sorted order.
   * Internally, it moves to the first record of each underlying scan.
   * The variable currrentscan is set to null, indicating that there is
   * no current scan.
   * 
