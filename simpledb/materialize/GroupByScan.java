...
public class GroupByScan implements Scan {
   ...
   * @param addfns      the aggregation functions
   */
   ...
   * The mehtod repeatedly reads underlying records until
   ...
   * be obtained from the saved group values.
   * Otherwise, the value is obtained from the
   * appropriate aggregation funtion.
   * 
   ...
   * be obtained from the saved group value.
   * Otherwise, the value is obtained from the
   * appropriate aggreation functionn.
   * 
   * @see simpledb.query.Scan#getVal(java.lang.String)
   */
