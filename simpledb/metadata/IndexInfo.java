...
public class IndexInfo {
   ...
   * finald all index records having a particular search key.
   ...
   * query; that is, it is the number of recores in the table
   ...
   * 
   * @paarm fname the specified field
   */
