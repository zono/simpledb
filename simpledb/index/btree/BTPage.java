 ...
 * A BTNode object contains this common funnctionality.
 * 
...
public class BTPage {
  ...
  /**
   * Calculate the postion where the first record having
   * the specified search key should be, then returns
   * the position before it.
   * 
   * @param searchkey the search key
   * @return the position before where the search key gose
   */
