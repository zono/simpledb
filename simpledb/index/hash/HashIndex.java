...
/**
 * A static has implementation of the Index interface.
...
public class HashIndex implements Index {
  ...
  private Constant seachkey = null;
   ...
   * having the specified seach key.
   * The method hashes the search key to determine the bucket,
   * and then opens a table scan on tthe file
  ...
  public void beforeFirst(Constant searchkey) {
    ...
    int bucket = searchkey.hasCode() % NUM_BUCKETS;
   ...
   * looking for a matchihng record, and returning false
  ...
  /**
   * Retieves the dataRID from the current record
  ...
  /**
   * Inserts a new record into the table scan tor the bucket.
   * 
   ...
   * the bucket. The method starts at the begginning of the
